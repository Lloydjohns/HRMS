...
$result = $DB->SELECT_ONE_WHERE("survey_result", "*", ["user_id" => AUTH_USER['user_id']]);
...
<div class="container mt-5">
    <?php if (!empty($result)) { ?>
        <h2 class="alert alert-success text-center fw-bold">You already submitted</h2>
        <p class="text-center text-muted">Thank you for completing the survey. Your feedback has been recorded.</p>
    <?php } else { ?>
