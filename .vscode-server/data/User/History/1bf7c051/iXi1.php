...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Optional: Add a question reference key below the chart
    const questionKey = document.createElement('div');
    questionKey.className = 'question-key mt-4';
    questionKey.innerHTML = '<h4>Question Reference:</h4><ol>' + 
        allQuestions.map((q, i) => `<li><strong>Q${i+1}:</strong> ${q}</li>`).join('') + 
        '</ol>';
    container.appendChild(questionKey);
});
</script>