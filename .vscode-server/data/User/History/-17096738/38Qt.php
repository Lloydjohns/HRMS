...
/* Add text shadow to white text for better readability */
h1, h2, p, .text-white {
  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);
}

/* Alternative: Add a semi-transparent overlay behind text */
.text-container {
...
/* Or use a gradient overlay on the entire image */
body::before {
  content: '';
  position: absolute;
  top: 0;
