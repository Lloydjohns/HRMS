...
<head>
    ...
    <style>
        ...
        /* Or use a thin outline around text */
        .text-container {
        text-shadow: 
            -1px -1px 0 #000,
            1px -1px 0 #000,
...
<body class="bg-dark" style="background: url('../assets/img/landing.jpg')no-repeat center center fixed; position: relative; background-size: cover;">
